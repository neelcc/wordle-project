...
const Home = () => {
  ...
  return (
    <div className=' bg-violet-200 h-screen px-2 text-center flex flex-col py-20 justify-center items-center ' >
        <p className=' px-6 py-1  rounded-full text-white font-semibold text-sm sm:text-xl  mb-2 bg-red-400 '  >For Thinkers</p>
      <h1 className='max-sm:w-55  text-2xl sm:text-4xl font-bold ' >Want to check your speed of thinking?</h1>
